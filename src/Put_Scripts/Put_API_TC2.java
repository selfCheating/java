...
public class Put_API_TC2 extends API_Trigger {
	File folder;
	Response response;
	...
	public void newFolder() {
		folder = Utility_Methods.createFolder("Put_API_TC2");
		
	}
@Test(retryAnalyzer = TestRetryAnalyzer.class, description = "Validate response status code for PUT_API_TC2")
	public void ValidateResponseStatusCode() {
		...
		@Test(dependsOnMethods = {"ValidateResponseStatusCode"}, description = "Validate response status code for PUT_API_TC2" )
        ...
        JsonPath jsp_req = new JsonPath(Put_API_R2());
        ...
        public void LogFile() throws IOException {
        	Utility_Methods.CreateLogFile("Put_API_TC2", folder, Put_APIEnv(), Put_API_R2(), response.getHeaders().toString(), res_body.asString());
