...
public class Put_API_DataProvider_sameClass extends API_Trigger {
	File folder;
	Response response;
	String requestBody;
	...
	public void newFolder() {
		folder = Utility_Methods.createFolder("Put_API_DataProvider_sameClass");
		
	}
        @Test(dataProvider = "requestData", retryAnalyzer = TestRetryAnalyzer.class, description = "Validate response status code for Put_API_TC1")
