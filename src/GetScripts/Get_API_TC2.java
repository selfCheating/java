...
public class Get_API_TC2 extends API_Trigger {
	...
	@Test(retryAnalyzer = TestRetryAnalyzer.class, description = "validate and extract status code for Get API TC2")
	...
	@Test(dependsOnMethods = {"ExtrctAndValidateResponseStatusCode"} , description = "validate response body for GET_API_TC2")
	...
	Utility_Methods.CreateLogFile("Get_API_TC2", folder, Get_APIEnv(), "",  response.getHeaders().toString(), res_body.asString());
	}
}
