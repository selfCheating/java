...
public class Post_API_DataProvider_sameClass extends API_Trigger {
	File folder;
	Response response;
	String requestBody;
	...
	public void newFolder() {
        ...
        @Test(dataProvider = "requestData", retryAnalyzer = TestRetryAnalyzer.class, description = "Validate response status code for POST_API_TC1")
