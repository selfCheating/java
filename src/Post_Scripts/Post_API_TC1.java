...
public class Post_API_TC1 extends API_Trigger {
	File folder;
	Response response;
	...
	public void ValidateResponseStatusCode() {
		response = API_Trigger.Trigger_Post_API(Post_API_R1(), Post_APIENV());
	...
	public void validateResponseBody() {
        ...
        JsonPath jsp_req = new JsonPath(Post_API_R1());
        ...
        public void LogFile() throws IOException {
        	Utility_Methods.CreateLogFile("Post_API_TC1", folder, Post_APIENV(), Post_API_R1(), response.getHeaders().toString(), res_body.asString());
