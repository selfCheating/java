...
public class Patch_API_DataProvider_sameClass extends API_Trigger {
	File folder;
	Response response;
	String requestBody;
	...
	public void newFolder() {
		folder = Utility_Methods.createFolder("Patch_API_DataProvider_SameClass");
		
	}
        @Test(dataProvider = "requestData", retryAnalyzer = TestRetryAnalyzer.class, description = "Validate response status code for Patch_API_TC1")
